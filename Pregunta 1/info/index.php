...
<body>
    ...
    <h3>Objetivos</h3>
    <ul>
        <li>Formar profesionales altamente calificados en ciencia y tecnología del área de la Informática para responder a las necesidades de la sociedad.</li>
        <li>Conducir proyectos de Investigación científica en el área de la Informática.</li>
        <li>Conducir proyectos de Interacción social en la región y el país.</li>
    </ul>
    <p>En la carrera se fomentan los siguientes valores:</p>
    <h3>Valores</h3>
    <ul>
        <li>Honestidad</li>
        <li>Ética</li>
        ...
        <li>Respeto a la diversidad cultural</li>
        <li>Respeto por el medio ambiente</li>
        <li>Rigor profesional y científico</li>
        <li>Puntualidad</li>
    </ul>
    </div>
    <hr>
    <div class="final">
    <h2>Links a paginas parecidas</h2>
    <ul>
        <li><a href="../index.php">Facultad</a></li>
        <li><a href="../mate/index.php">Matematicas</a></li>
        <li><a href="../fisica/index.php">Fisica</a></li>
